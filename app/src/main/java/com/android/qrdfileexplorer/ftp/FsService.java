...
import com.android.qrdfileexplorer.ftp.server.SessionThread;
import com.android.qrdfileexplorer.ftp.server.TcpListener;
...
public class FsService extends Service implements Runnable {
    ...
    static public final String ACTION_STARTED = "com.android.qrdfileexplorer.FTPSERVER_STARTED";
    static public final String ACTION_STOPPED = "com.android.qrdfileexplorer.FTPSERVER_STOPPED";
    static public final String ACTION_FAILEDTOSTART = "com.android.qrdfileexplorer.FTPSERVER_FAILEDTOSTART";

    // RequestStartStopReceiver listens for these actions to start/stop this server
    static public final String ACTION_START_FTPSERVER = "com.android.qrdfileexplorer.ACTION_START_FTPSERVER";
    static public final String ACTION_STOP_FTPSERVER = "com.android.qrdfileexplorer.ACTION_STOP_FTPSERVER";
