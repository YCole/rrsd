...
public final class CatGlobal {
    ...
    private static final Set<String> DISABLED_TAGS = new HashSet<String>();
    private static final List<String> DISABLED_PACKAGES = new ArrayList<String>();

    private static CatLog defaultCatLog = new CatLazy();
    private static final Map<String, CatLog> PACKAGE_CAT_LOGS = new HashMap<String, CatLog>();
